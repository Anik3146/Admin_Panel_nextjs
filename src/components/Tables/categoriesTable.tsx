          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  sellCount: parseInt(e.target.value),
                })
              }
              min="0"
              required
        ...
        <table className="w-full table-auto">
          ...
          <tbody>
            <tr>
              <td className="h-[60px] border-[#eee] px-4 py-4 dark:border-dark-3 xl:pl-7.5">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                  ...
                  <p className="text-body-lg font-medium text-dark dark:text-dark-6">
                    {initialFormData.parent}
                  </p>
                </div>
              </td>
              <td className="border-[#eee] px-4 py-4 dark:border-dark-3">
                <p className="text-dark dark:text-white">
                  {initialFormData.productType}
                </p>
              </td>
              <td className="border-[#eee] px-4 py-4 dark:border-dark-3">
                <p className="text-dark dark:text-white">
                  {/* Safely check if children is an array */}
                  {Array.isArray(initialFormData.children)
                    ? initialFormData.children.join(', ')
                    : initialFormData.children}
                </p>
              </td>
              <td className="border-[#eee] px-4 py-4 dark:border-dark-3">
                <p className="text-dark dark:text-white">
              ...
              <td className="border-[#eee] px-4 py-4 dark:border-dark-3">
                <p className="text-dark dark:text-white">
                  {initialFormData.featured ? 'Yes' : 'No'}
                </p>
              </td>
              <td className="border-[#eee] px-4 py-4 dark:border-dark-3">
                <p className="text-dark dark:text-white">
                  {initialFormData.sellCount}
                </p>
              </td>
